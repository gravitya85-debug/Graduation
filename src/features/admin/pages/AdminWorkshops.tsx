...
import { Calendar, Loader2, Plus, AlertTriangle, Users, BookOpen } from 'lucide-react';
import PageBanner from '../../../components/PageBanner';
import WorkshopTable, { Workshop } from '../components/WorkshopTable';
import WorkshopForm from '../components/WorkshopForm';
import WorkshopRegistrations from '../components/WorkshopRegistrations';
...
export default function AdminWorkshops() {
    ...
    const fetchWorkshops = async () => {
        try {
            ...
            console.error(error);
            toast.error(t('admin.loadError') || 'Failed to fetch workshops');
        } finally {
            setLoading(false);
        }
    };
